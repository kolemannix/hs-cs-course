...
object UnitXImages extends App {
  ...
  def lightenSimple(pixel: Pixel): Pixel = {
    ...
    val greenLightened = clamp255(pixel.green + 10)
    val blueLightened = clamp255(pixel.blue + 10)
    Pixel(redLightened, greenLightened, blueLightened, pixel.alpha)
  }

  def swapRedAndGreen(original: Pixel): Pixel = {
